...
class InfoNCE(nn.Module):
    ...
    def __init__(self,modal1_dim_in,model2_dim_in, embed_dropout,temperature=0.1, reduction='mean', negative_mode='unpaired'):
        super().__init__()
        self.temperature = temperature
        self.reduction = reduction
        self.negative_mode = negative_mode
        self.modal1_in = modal1_dim_in
        self.modal2_in = model2_dim_in
        self.modal1_hidden, self.model2_hidden = 30, 30
        self.embed_dropout = embed_dropout

        self.info_proj_query = nn.Conv1d(self.modal1_in, self.modal1_hidden, kernel_size=1, padding=0, bias=False)
        self.info_proj_positive = nn.Conv1d(self.modal2_in, self.model2_hidden, kernel_size=1, padding=0, bias=False)
    ...
    def forward(self, query, positive_key, negative_keys=None):
        ...
        proj_x_av = x_av_ if self.modal2_in == self.model2_hidden else self.info_proj_positive(x_av_)
...
if __name__=="__main__":
    ...
    info_loss=InfoNCE(modal1_dim_in=784,model2_dim_in=30,embed_dropout=0.1)
